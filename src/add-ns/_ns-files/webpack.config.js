...
module.exports = env => {
    ...
    const ngToolsWebpackOptions = { tsConfigPath: './tsconfig<%= nsext %>.json' };

    const config = {
        context: resolve('./<%= sourcedir %>'),
        target: nativescriptTarget,
        entry: {
            bundle: './<%= main %><%= nsext %>.ts',
            vendor: './vendor',
        },
        output: {
            pathinfo: true,
        ...
        plugins: [
            ...
            new nsWebpack.NativeScriptAngularCompilerPlugin(
                Object.assign({
                    entryModule: resolve(__dirname, '<%= entryModulePath %>#<%= entryModuleName %>'),
